...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "EEF — AI Internship Roadmap Engine" },
      { name: "twitter:description", content: "AI-powered personalized engineering internship roadmaps" },
    ...
    links: [
      ...
      { rel: "mask-icon", href: "/logo.svg", color: "#06b6d4" },
